...
% WBDCB window button down callback
    ...
    % WBUCB window button up callback
        ...
        xchannel = r_wbucb.input_elements.input_xchannel_popup.Value;
        ychannel = r_wbucb.input_elements.input_ychannel_popup.Value;
        part = r_wbucb.input_elements.input_parts_popup.Value;
        segment = r_wbucb.input_elements.input_segments_popup.Value;
