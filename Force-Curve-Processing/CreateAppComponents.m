...
save_curve_text = uicontrol('Parent', proc_status_info_grid,...
    'Style', 'text',...
    'String', 'Save Curves:',...
    'HorizontalAlignment', 'left');
...
calibration_text = uicontrol('Parent', proc_status_info_grid,...
    'Style', 'text',...
...
%--------------------------------------------------------------------------
%             Do not use TextLabel, becaus its behaviour is wierd!
%--------------------------------------------------------------------------
% tooltip = 'Displays wether a Savepath for processed curves has been specified.';
...
curve_type_text = uicontrol('Parent', curve_type_grid,...
    'Style', 'text',...
    'String', 'Force-Curve Type:',...
    'HorizontalAlignment', 'left');
curve_type_text.Tag = 'curve_type_text';

easy_import_text = uicontrol('Parent', curve_type_grid,...
    'Style', 'text',...
    'String', 'Easy Import:',...
    'HorizontalAlignment', 'left');
easy_import_text.Tag = 'easy_import_text';

curve_type_status = uicontrol('Parent', curve_type_grid,...
    'Style', 'text',...
...
easy_import_status = uicontrol('Parent', curve_type_grid,...
    'Style', 'text',...
    'String', string,...
    'HorizontalAlignment', 'right');
